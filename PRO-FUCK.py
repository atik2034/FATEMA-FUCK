...
time.sleep(3)
os.system('espeak -a 300 " HEY FATEMA FUCK,   YOU,"')
os.system('clear')
...
#-------------------// APPROVAL \\---------------------#
import os,httpx
sexkey = "ATIK~("+str(os.getuid())+"=(CYBER)="+str(os.getuid())+")~PRO"
def approval():
    sexkey = "ATIK~("+str(os.getuid())+"=(CYBER)="+str(os.getuid())+")~PRO"
    ress=httpx.get("https://github.com/atik2034/approval.txt/blob/main/Approval.txt").text
    if sexkey in ress:
        menu()
    else:
        print("\x1b[38;5;244m KEY IS NOT APPROVED 7 DAY 1600 TAKA")
        os.system("clear")
        print(logo)
...
\x1b[1;97m┌━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┐\033[1;37m
\x1b[1;97m┃\x1b[38;5;244m(\x1b[1;97m✘\x1b[38;5;244m)\x1b[38;5;46m AVOTHER  \x1b[38;5;244m–\x1b[38;5;46m➤\x1b[38;5;244m [\x1b[38;5;46mATIK CYBER\x1b[38;5;244m] \x1b[1;97m              ┃
\x1b[1;97m┃\x1b[38;5;244m(\x1b[1;97m✘\x1b[38;5;244m)\x1b[38;5;46m FACEBOOK \x1b[38;5;244m–\x1b[38;5;46m➤\x1b[38;5;244m [\x1b[38;5;46mATIK CYBER\x1b[38;5;244m] \x1b[1;97m           ┃
